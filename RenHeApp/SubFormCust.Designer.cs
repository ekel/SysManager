namespace RenHeApp
{
    partial class SubFormCust
    {
        ...
        private void InitializeComponent()
        {
			...
			this.askflagDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.asktimeDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.deal_flag = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			// grpBox2
			// 
			this.grpBox2.Controls.Add(this.label18);
            ...
            this.askflagDataGridViewTextBoxColumn,
            this.asktimeDataGridViewTextBoxColumn,
            this.deal_flag});
			this.dataGridView.DataSource = this.custinfoBindingSource;
			...
			this.addressDataGridViewTextBoxColumn.HeaderText = "住址";
			...
			this.companyDataGridViewTextBoxColumn.HeaderText = "工作单位";
			...
			// 
			// askflagDataGridViewTextBoxColumn
			// 
			this.askflagDataGridViewTextBoxColumn.DataPropertyName = "ask_flag";
			this.askflagDataGridViewTextBoxColumn.HeaderText = "咨询方式";
			this.askflagDataGridViewTextBoxColumn.Name = "askflagDataGridViewTextBoxColumn";
			this.askflagDataGridViewTextBoxColumn.ReadOnly = true;
			// 
			// asktimeDataGridViewTextBoxColumn
			// 
			this.asktimeDataGridViewTextBoxColumn.DataPropertyName = "ask_time";
			this.asktimeDataGridViewTextBoxColumn.HeaderText = "咨询时间";
			this.asktimeDataGridViewTextBoxColumn.Name = "asktimeDataGridViewTextBoxColumn";
			this.asktimeDataGridViewTextBoxColumn.ReadOnly = true;
			// 
			// deal_flag
			// 
			this.deal_flag.DataPropertyName = "deal_flag";
			this.deal_flag.HeaderText = "是否成交";
			this.deal_flag.Name = "deal_flag";
			this.deal_flag.ReadOnly = true;
			// 
            ...
            "男",
            "女"});
			this.cmbSex.Location = new System.Drawing.Point(206, 20);
			...
			this.dateTimeBirth.Location = new System.Drawing.Point(334, 19);
			...
			this.dateTimeAsk.Value = new System.DateTime(2015, 10, 12, 0, 0, 0, 0);
			// 
			// label1
			// 
			...
			this.picBox.DataBindings.Add(new System.Windows.Forms.Binding("Image", this.custinfoBindingSource, "photo", true, System.Windows.Forms.DataSourceUpdateMode.Never));
			...
			this.btnPic.Location = new System.Drawing.Point(1044, 194);
			...
			this.label18.Location = new System.Drawing.Point(1125, 36);
			this.label18.Name = "label18";
			this.label18.Size = new System.Drawing.Size(19, 149);
			this.label18.TabIndex = 7;
			this.label18.Text = "图片大小不要超过64 KB";
			// 
			// label19
			// 
        ...
        private System.Windows.Forms.DataGridViewTextBoxColumn askflagDataGridViewTextBoxColumn;
        private System.Windows.Forms.DataGridViewTextBoxColumn asktimeDataGridViewTextBoxColumn;
        private System.Windows.Forms.DataGridViewTextBoxColumn deal_flag;
